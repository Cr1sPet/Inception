...
wp core install --allow-root --url=${DOMAIN_NAME} --title=wordpress --admin_user=${WORDPRESS_ROOT_LOGIN} --admin_password=${MYSQL_ROOT_PASSWORD} --admin_email=${WORDPRESS_ROOT_EMAIL};
